    ...
    <div className="min-h-screen flex items-center justify-center pt-16 pb-24 px-4 relative">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Join ElectroStore today</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))}
                placeholder="Your name" className="input-light w-full pl-10 text-slate-800" required />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))}
                placeholder="you@example.com" className="input-light w-full pl-10 text-slate-800" required />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type={showPw ? 'text' : 'password'} value={form.password}
                ...
                placeholder="Min 6 characters" className="input-light w-full pl-10 pr-10 text-slate-800" required />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" value={form.confirmPassword}
                ...
                placeholder="Re-enter password" className="input-light w-full pl-10 text-slate-800" required />
            </div>
          </div>
